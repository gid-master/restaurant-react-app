...
const CheckoutGiftCard = forwardRef((props:CheckoutGiftCardProps, ref: Ref<RefGiftCard>) =>{
  ...
  return (
    <form noValidate className="gift-card-form">
      <div className={classNames('controller', { error: errors.giftCard })}>
        <label className="label"><small>Type the gift code</small></label>
        <input
          name="giftCard"
          type="text"
          className="input"
