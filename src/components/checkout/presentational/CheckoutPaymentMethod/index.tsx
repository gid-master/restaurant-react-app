...
import { PaymentMethodEnum, ICreditCard } from '@/interfaces/ICheckout';
    ...
    <div className="checkout-payment-method">
      <div className="item">
        <div className="method-header">
          <img className="image" src={require('@/assets/icons/dark/card.svg').default} alt="credit card" />
        ...
        <div className={classNames('content', { open: props.paymentMethod === PaymentMethodEnum.CREDIT_CARD })}>
          <CheckoutCreditCard ref={refCreditCard} disabled={props.disabled} />
        </div>
      </div>
      <div className="item">
        <div className="method-header">
          <img className="image" src={require('@/assets/icons/dark/gift.svg').default} alt="gift card" />
        ...
        <div className={classNames('content', { open: props.paymentMethod === PaymentMethodEnum.GIFT_CARD })}>
